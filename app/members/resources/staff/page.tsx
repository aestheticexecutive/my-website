      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 pb-20">
        ...
        >
          <div className="p-7 flex items-center gap-5">
            ...
            <div className="flex-1">
              <p className="text-sm font-medium mb-1" style={{ color: "#fffdf6" }}>Interview Scorecard</p>
              <p className="text-xs leading-relaxed" style={{ color: "rgba(255,253,246,0.5)" }}>A candidate rating rubric on the same MBI framework — skill, attitude, passion — plus communication, reliability, and an overall recommendation.</p>
            </div>
            <span
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 pb-20">
        ...
        >
          <div className="p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-8">
            ...
            >
              <FileSignature size={24} style={{ color: "#a28c75" }} />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2 flex-wrap">
                <h3 className="font-display text-2xl font-light" style={{ color: "#fffdf6" }}>
              ...
              <ul className="flex flex-wrap gap-x-6 gap-y-1">
                {["Standard offer letter content", "Editable final copy", "Save multiple named letters", "Print, save as PDF, or copy for email"].map((feat) => (
                  <li key={feat} className="text-xs flex items-center gap-1.5" style={{ color: "rgba(162,140,117,0.65)" }}>
                    <span style={{ color: "#a28c75" }}>·</span> {feat}
                  </li>
                ))}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 pb-20">
        ...
        >
          <div className="p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-8">
            ...
            <div className="flex-1">
              ...
              <ul className="flex flex-wrap gap-x-6 gap-y-1">
                {["Provider & Support Staff templates", "Add / remove criteria", "Save multiple named checklists", "Print / save as PDF"].map((feat) => (
                  <li key={feat} className="text-xs flex items-center gap-1.5" style={{ color: "rgba(162,140,117,0.65)" }}>
                    <span style={{ color: "#a28c75" }}>·</span> {feat}
                  </li>
                ))}
        ...
        >
          <div className="p-7 flex flex-col md:flex-row md:items-center gap-5">
            ...
            >
              <Wand2 size={18} style={{ color: "#a28c75" }} />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-1.5 flex-wrap">
                <h3 className="font-display text-lg font-light" style={{ color: "#fffdf6" }}>
        ...
        >
          <div className="p-7 md:p-8 flex flex-col md:flex-row md:items-center gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-1.5 flex-wrap">
                <h3 className="font-display text-xl font-light" style={{ color: "#fffdf6" }}>
                  Peer Recognition Program Guide
                </h3>
                <span
                  className="text-xs px-2.5 py-1 rounded-full font-medium tracking-wide"
                  style={{
              ...
              <p className="text-sm leading-relaxed" style={{ color: "rgba(255,253,246,0.52)" }}>
                Peer-to-peer shoutouts and a structured employee-of-the-month process — the specific,
                actionable mechanics of recognition, distinct from the broader culture work in Living
                Your Values.
              </p>
            </div>
        ...
        >
          <div className="p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-8">
            <div
              ...
              style={{ background: "rgba(162,140,117,0.12)", border: "1px solid rgba(162,140,117,0.25)" }}
            >
              <FileWarning size={24} style={{ color: "#a28c75" }} />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2 flex-wrap">
                <h3 className="font-display text-2xl font-light" style={{ color: "#fffdf6" }}>
              ...
              <ul className="flex flex-wrap gap-x-6 gap-y-1">
                {["Fully editable checkbox options", "Save multiple named records", "Employee sign-off tracking", "Print / save as PDF"].map((feat) => (
                  <li key={feat} className="text-xs flex items-center gap-1.5" style={{ color: "rgba(162,140,117,0.65)" }}>
                    <span style={{ color: "#a28c75" }}>·</span> {feat}
                  </li>
                ))}
        ...
        >
          <div className="p-7 flex flex-col md:flex-row md:items-center gap-5">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-1.5 flex-wrap">
                <h3 className="font-display text-lg font-light" style={{ color: "#fffdf6" }}>
                  Staff Retention &amp; Burnout Prevention Guide
                </h3>
                <span
                  className="text-xs px-2.5 py-1 rounded-full font-medium tracking-wide"
                  style={{
              ...
              <p className="text-sm leading-relaxed" style={{ color: "rgba(255,253,246,0.52)" }}>
                Scheduling flexibility, PTO design, and workload balance — the three levers that keep
                good people from quietly deciding to leave, plus warning signs to catch it early.
              </p>
            </div>
            <div className="flex-shrink-0">
              <span
        ...
        >
          <div className="p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-8">
            <div
              ...
              style={{ background: "rgba(162,140,117,0.12)", border: "1px solid rgba(162,140,117,0.25)" }}
            >
              <NotebookPen size={24} style={{ color: "#a28c75" }} />
            </div>
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2 flex-wrap">
                <h3 className="font-display text-2xl font-light" style={{ color: "#fffdf6" }}>
              ...
              <ul className="flex flex-wrap gap-x-6 gap-y-1">
                {["6 pre-loaded agenda sections", "Fully customizable template", "Dated meeting history", "Add / delete sections anytime"].map((feat) => (
                  <li key={feat} className="text-xs flex items-center gap-1.5" style={{ color: "rgba(162,140,117,0.65)" }}>
                    <span style={{ color: "#a28c75" }}>·</span> {feat}
                  </li>
                ))}
