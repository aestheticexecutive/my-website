...
import { ArrowLeft, Megaphone, ExternalLink, Users, BookOpen, Handshake, Building2, Share2, Search, Camera, CalendarDays, MapPin, Star, MessageSquare, Globe, FileText, Mail, Zap, TrendingUp, Gift, Award, DollarSign } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <DollarSign size={12} style={{ color: "#a28c75" }} />
                      <span className="text-xs font-medium tracking-wide" style={{ color: "#fffdf6" }}>
                        {feat.label}
                      </span>
                    </div>
          ...
          >
            <div className="p-8 md:p-10 flex flex-col md:flex-row md:items-center gap-8">
              <div
                ...
                style={{ background: "rgba(162,140,117,0.12)", border: "1px solid rgba(162,140,117,0.25)" }}
              >
                <Gift size={24} style={{ color: "#a28c75" }} />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2 flex-wrap">
                  ...
                  <span
                    ...
                    style={{ background: "rgba(162,140,117,0.1)", border: "1px solid rgba(162,140,117,0.22)", color: "rgba(162,140,117,0.75)" }}
                  >
                    Guide
                  </span>
                </div>
                ...
                <ul className="flex flex-wrap gap-x-6 gap-y-1">
                  {["Give $50 / Get $50 model", "Physical & digital referral cards", "Team scripts for every patient moment", "Seasonal promotion ideas"].map((feat) => (
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 py-12">
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div
                    ...
                    style={{ background: "rgba(162,140,117,0.12)", border: "1px solid rgba(162,140,117,0.22)" }}
                  >
                    <Award size={15} style={{ color: "#a28c75" }} />
                  </div>
                  <span
                    className="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium tracking-wide"
                    style={{ color: "#c8b3a3", background: "rgba(200,179,163,0.08)", border: "1px solid rgba(200,179,163,0.2)" }}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { label: "Usage Audit", desc: "Track in-house members and Allē, Aspire, Evolus & Reva enrollment against your patient base" },
                  { label: "Promotion Checklist", desc: "See at a glance where memberships & rewards are — and aren't — being promoted" },
                  { label: "Opportunity + Action Plan", desc: "Pre-loaded with 6 example opportunities across both programs — edit or add your own" },
                  { label: "Tracking Plan", desc: "4 pre-loaded metrics with how they're tracked and how often you'll review them" },
                ].map((feat) => (
                  <div
                    key={feat.label}
                    className="rounded-lg p-4"
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      <Award size={12} style={{ color: "#a28c75" }} />
                      <span className="text-xs font-medium tracking-wide" style={{ color: "#fffdf6" }}>
                        {feat.label}
                      </span>
                    </div>
