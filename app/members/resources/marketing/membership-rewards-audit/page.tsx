...
function migrateMembershipAuditData(raw: unknown): StoreData {
  const parsed = (raw ?? {}) as { audits?: unknown };
  return { audits: Array.isArray(parsed.audits) ? (parsed.audits as MembershipAudit[]) : [] };
}
