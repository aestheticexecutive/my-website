...
export const searchIndex: SearchEntry[] = [
  ...
  { title: "Goal Tracker", description: "Set a target for the period, log progress and business days remaining, and see exactly what you need per business day to hit it. Printable worksheet, saved by name and date range.", category: "Operations", type: "Tool", href: "/members/resources/operations/goal-tracker" },
  { title: "Goal Setting Guide", description: "Suggested goals across revenue, acquisition, retention, and provider productivity, plus why breaking big goals into weekly and daily pace keeps a team on track.", category: "Operations", type: "Guide", href: "/members/resources/operations/goal-setting-guide" },
  { title: "Inventory Management System", description: "Track products by category, vendor, unit, and cost. Log physical counts and incoming stock, see live on-site dollar value, and get red/yellow par-level alerts.", category: "Operations", type: "Tool", href: "/members/resources/operations/inventory-management" },
  ...
  { title: "Offer Letter Builder", description: "A complete employment offer letter with every standard section already written — fill in candidate details, edit the final copy, then save as a PDF or copy it for email.", category: "Staff", type: "Tool", href: "/members/resources/staff/offer-letter" },
  ...
  { title: "Treatment Profitability Template", description: "Three-tab Excel workbook pre-loaded with 15 common treatments — auto-calculating profit and margin with conditional color coding.", category: "Templates", type: "Template", href: "/downloads/ae-treatment-profitability.xlsx" },
  { title: "Patient Care Coordinator Evaluation Form", description: "Role-specific performance evaluation covering service quality, communication, scheduling, and patient experience.", category: "Templates", type: "Template", href: "/downloads/Patient-Care-Coordinator-Evaluation.docx" },
  { title: "Med Spa Manager Evaluation Form", description: "Role-specific performance evaluation covering leadership, operations, revenue management, and team development.", category: "Templates", type: "Template", href: "/downloads/Med-Spa-Manager-Evaluation.docx" },
  { title: "Provider / Injector Evaluation Form", description: "Role-specific performance evaluation covering clinical skill, patient consultation, safety protocol, and treatment outcomes.", category: "Templates", type: "Template", href: "/downloads/Provider-Injector-Evaluation.docx" },
  { title: "Strategic Community Partnerships Guide", description: "The full Community Partnerships playbook as a shareable Word doc.", category: "Templates", type: "Template", href: "/templates/community-partnerships.docx" },
  { title: "Patient Referral Program Guide", description: "The full 12-step patient referral program playbook as a shareable Word doc.", category: "Templates", type: "Template", href: "/templates/patient-referral-program.docx" },
  { title: "Referral Partner Program Guide", description: "The full Referral Partner Program playbook as a shareable Word doc.", category: "Templates", type: "Template", href: "/templates/referral-partner-program.docx" },
];
